...
<!--fin menu 	-->
		...
		<main>
		  	...
		  	<div class="map" id="map">
		  		<div class="map_guad" >
		  			<svg xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 850 700">
		  				<defs>
							...
							<!-- Guadeloupe -->
						<g>
							<a class="bkgGuadGt" id="gt" title="Grande terre" href="#" xlink:title="Grande terre" >
							...
							<a class="bkgGuadBt" id="bt"      href="#" title="Basse terre" xlink:title="Basse terre">
							...
							<a class="bkgGuadIpt" id="ipt1"    href="#" xlink:title="iles-petite-terre">
							...
							<a class="bkgGuadMg" id="mg"      href="#" xlink:title="Marie-Galante">
							...
							<a class="bkgGuadIs" id="is"      href="#" xlink:title="Îles de Saintes">
		  		...
		  		<div class="map_list">
		  			<ul>
		  				<li> <a href="http://www.google.fr/?q=1">  Grande terre               </a> </li>
		  				<li> <a href="http://www.google.fr/?q=1">  Basse  terre               </a> </li>
		  				<li> <a href="http://www.google.fr/?q=2">  Le Désirable               </a> </li>
		  				<li> <a href="http://www.google.fr/?q=3">  Îles de la petite terre    </a> </li>
		  				<li> <a href="http://www.google.fr/?q=4">  Fajou                      </a> </li>
		  				<li> <a href="http://www.google.fr/?q=5">  Marie-Galante              </a> </li>
		  				<li> <a href="http://www.google.fr/?q=6">  Îles de Saintes            </a> </li>
		  			</ul>
		  		</div>
		  	</div>
	<!--fin menu 	-->
