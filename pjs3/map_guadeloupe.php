...
<!--fin menu 	-->
		<main>
			<div class="map_conteneur" id="map">
				<div class="map_list map_list2">
			  			<ul>
			  				<li> <a href="http://www.google.fr/?q=1" id="nom-gt">  Grande terre             </a> </li>
			  				<li> <a href="http://www.google.fr/?q=1" id="nom-bt">  Basse  terre             </a> </li>
			  				<li> <a href="http://www.google.fr/?q=2" id="nom-ld">  Le Désirable             </a> </li>
			  				<li> <a href="http://www.google.fr/?q=3" id="nom-ipt">  Îles de la petite terre  </a> </li>
			  				<li> <a href="http://www.google.fr/?q=4" id="nom-fj">  Fajou                    </a> </li>
			  				<li> <a href="http://www.google.fr/?q=5" id="nom-mg">  Marie-Galante            </a> </li>
			  				<li> <a href="http://www.google.fr/?q=6" id="nom-ids">  Îles de Saintes          </a> </li>
			  			</ul>
			  		</div>
			  	<div class="map_conteneur_guad" >
			  		
			  		<div class="map_guad" >
			  			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 850 700">
			  				<defs>
							</defs>
