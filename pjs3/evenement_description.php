...
<div class="conteneur_desc">
	...
	<p>
		Une Croisière de huit jours à bord du Costa Magica . Départ du port de Pointe-à-Pitre (Guadeloupe), visitez Scarborough (Tobago), Grenade (Antilles), Bridgetown (La Barbade), Castries (Antilles), Fort-de-France (Martinique) et débarquez au port de Pointe-à-Pitre (Guadeloupe).
